...
var languages = {
    ...
    'Chinese': {
        'id_switchBtn': '中文',
        'id_View_Vedio': "观看视频",
        'id_content_title': "综合机电系统培训",
        'id_content_content_1': "在第三年，我担任了电控团队的负责人。为了整理自己的思路也为了对新成员进行培训，我将过去三年积累的知识和经验整理成一份超过100,000字的文件，并制作了400多张PPT，整个培训持续了两个月。",
        'id_content_content_2': "培训内容包括机电系统设计、STM32编程、嵌入式系统架构、C++基本语法、基础机电系统知识，以及对团队代码框架的深入解释。详细的文件和PPT可在本网站的博客上查看。",
        'id_Blog': "博客",
        'id_Abl_head': "能力：",
