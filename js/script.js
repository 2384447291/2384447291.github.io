...
var languages = {
    ...
    'Chinese': {
        ...
        'id_experience_content_3_1': '- 由于去年团队的出色表现，许多高年级成员在实现全国大赛目标后选择退役。为了团队也为了不负去年学长的指导，我觉得自己有必要留下来。更重要的是，由于去年的半期中途加入，我并没有赶上队里的体系化培训，即使下半年很努力的追赶，我的能力并不配得上去年的成绩，基础不牢导致我在比赛前期犯了很多低级错误,险些拖累了团队。为了证明自己或弥补去年的过失，我决定再继续打一年比赛。',
        ...
        'id_experience_content_6_1': '- 回顾打比赛这一整年，这是一个几乎没有睡眠与生活的紧张时期。每天的日程是醒了就来实验室工作，工作到精疲力竭才敢睡觉。我要感谢我的队友和命运，在那一年的全国比赛中，ARTINX再次重回了巅峰，获得了全国第11名的好成绩。',
